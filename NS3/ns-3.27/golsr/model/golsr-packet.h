...
#ifndef GOLSRPACKET_H
#define GOLSRPACKET_H
...
uint64_t         m_originPosz;          ///< Originator Position x
};
...
public:
  /// c-tor
  PositionHeader (uint64_t dstPosx = 0, uint64_t dstPosy = 0, uint64_t dstPosz = 0, uint32_t updated = 0, uint64_t recPosx = 0, uint64_t recPosy = 0, uint64_t recPosz = 0, uint8_t inRec  = 0, uint64_t lastPosx = 0, uint64_t lastPosy = 0,  uint64_t lastPosz = 0, uint8_t forward = 0);
