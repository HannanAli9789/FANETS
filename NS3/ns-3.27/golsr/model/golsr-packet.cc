...
#include "golsr-packet.h"
#include "ns3/address-utils.h"
#include "ns3/packet.h"
#include "ns3/log.h"

NS_LOG_COMPONENT_DEFINE ("golsrPacket");
...
{
  static TypeId tid = TypeId ("ns3::golsr::TypeHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::golsr::HelloHeader")
    .SetParent<Header> ()
...
{
  NS_LOG_DEBUG ("Serialize X " << m_originPosx << " Y,Z " << m_originPosy);
...
{
  return (m_originPosx == o.m_originPosx && m_originPosy == o.m_originPosy && m_originPosz == o.m_originPosz);
}
...
// Position
//-----------------------------------------------------------------------------
PositionHeader::PositionHeader (uint64_t dstPosx, uint64_t dstPosy, uint64_t dstPosz, uint32_t updated, uint64_t recPosx, uint64_t recPosy, uint64_t recPosz, uint8_t inRec, uint64_t lastPosx, uint64_t lastPosy,uint64_t lastPosz, uint8_t forward)
  : m_dstPosx (dstPosx),
    m_dstPosy (dstPosy),
    m_dstPosz (dstPosz),       
    m_updated (updated),
...
{
  return (m_dstPosx == o.m_dstPosx && m_dstPosy == o.m_dstPosy && m_dstPosz == o.m_dstPosz && m_updated == o.m_updated && m_recPosx == o.m_recPosx && m_recPosy == o.m_recPosy && m_recPosz == o.m_recPosz && m_inRec == o.m_inRec && m_lastPosx == o.m_lastPosx && m_lastPosy == o.m_lastPosy && m_lastPosz == o.m_lastPosz && m_forward == o.m_forward);
}
