...
// HELLO
//-----------------------------------------------------------------------------
HelloHeader::HelloHeader (uint64_t originPosx, uint64_t originPosy , uint64_t originPosz)
...
// Position
//-----------------------------------------------------------------------------
PositionHeader::PositionHeader (uint64_t dstPosx, uint64_t dstPosy, uint64_t dstPosz, uint32_t updated, uint64_t recPosx, uint64_t recPosy, uint64_t recPosz, uint8_t inRec, uint64_t lastPosx, uint64_t lastPosy, uint64_t lastPosz)
  : m_dstPosx (dstPosx),
    m_dstPosy (dstPosy),
    m_dstPosz (dstPosz),
    m_updated (updated),
...
{
  return (m_dstPosx == o.m_dstPosx && m_dstPosy == o.m_dstPosy && m_dstPosz == o.m_dstPosz && m_updated == o.m_updated && m_recPosx == o.m_recPosx && m_recPosy == o.m_recPosy && m_recPosz == o.m_recPosz && m_inRec == o.m_inRec && m_lastPosx == o.m_lastPosx && m_lastPosy == o.m_lastPosy && m_lastPosz == o.m_lastPosz);
}
